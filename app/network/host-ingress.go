...
func startHostIngress(parent context.Context, targets *networkTargets, access *networkAccess, appID func() string, warn func(error)) (*hostIngress, error) {
	...
	client := &local.Client{}
	proxy := targets.proxy(false, nil, warn)
