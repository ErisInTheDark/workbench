...
} from "workbench-shared/workbench/transcript/thread-transcript-display-planner";
import type {
...
function timelineEntriesFromJson(
  ...
  return thread.turns.flatMap((turn) => {
    ...
    payload: {
      ...
      effectiveCompletedAt: entry.completedAt ?? entry.lastSeenAt,
      effectiveStartedAt: entry.startedAt ?? entry.firstSeenAt,
    },
    turnId,
    type: "timeline",
  }));
