...
export default function WorkbenchUsageDrivers({
  ...
  stats: Pick<WorkbenchStatsResponse, "models" | "topThreads">;
}) {
  return (
    <section aria-labelledby="drivers-heading" className="space-y-5">
      ...
      <div className="grid gap-8 lg:grid-cols-2">
        <div className="min-w-0">
          ...
          ) : <p className="m-0 text-[0.8rem] text-muted">No model usage in this range.</p>}
        </div>
        <div className="min-w-0">
          ...
          ) : <p className="m-0 text-[0.8rem] text-muted">No thread usage in this range.</p>}
        </div>
      </div>
    </section>
  );
