...
export default function WorkbenchMenuAction({
  ...
  return <button
    ...
    className={`
      enabled:cursor-pointer flex w-full items-center gap-2 rounded-xl px-3 py-2 text-left text-muted transition
      ...
      disabled:cursor-default disabled:opacity-50 disabled:hover:bg-transparent disabled:hover:text-muted
