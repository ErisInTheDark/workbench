...
8. After completing implementation, it's time for the review pass: Summarise the changes to the user as commentary and then use the ask_questions tool for a confirmation from them. The options you must give the user:
