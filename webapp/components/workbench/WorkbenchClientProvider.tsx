...
import type { MountedWorkbenchClient } from "../../lib/WorkbenchClient";
import type {
  ExplorerSnapshot,
  ThreadPayload,
  WorkbenchControls,
...
import type WorkbenchClientStateController from "../../lib/workbench/state/WorkbenchClientStateController";
...
import type { WorkbenchRoute } from "../../lib/workbench/navigation/workbench-route";
...
export function useWorkbenchClientMount(options: WorkbenchClientMountOptions): WorkbenchClientController {
  ...
  useEffect(() => {
    ...
    const timeoutId = window.setTimeout(() => {
      void import("../../lib/WorkbenchClient").then(async ({ WorkbenchClient }) => {
