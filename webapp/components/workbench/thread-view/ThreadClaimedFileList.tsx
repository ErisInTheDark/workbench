/*
 * Exports:
 * - default ThreadClaimedFileList: render static claimed or attempted Git arc path rows. Keywords: thread, git, arc, claim, file list.
 */
import { toWorkspaceDisplayPath, type WorkspaceFileLinkRoot } from "../../../lib/workbench/markdown/markdown-links";
import ProjectFilePath from "../ProjectFilePath";
import { GitArcClaimIcon } from "./GitArcIcon";
      ...
      {paths.map((filePath) => {
        ...
        return (
          <div className="flex min-w-0 items-baseline gap-1 py-0.5 pl-6 text-[0.86em] leading-[1.5] text-muted" key={filePath}>
            <span className="-mt-0.5 inline-flex shrink-0 self-center" aria-hidden="true"><GitArcClaimIcon /></span>
