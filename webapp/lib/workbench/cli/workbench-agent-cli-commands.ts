...
const LEGACY_CHECKPOINT_MIGRATION_GUIDE = [
  ...
  "13. Propose message changes to an exact accepted commit without an active arc: wb git arc propose --amend <proposal-id> -m <replacement-title> [-m <replacement-description>]",
  "14. Amend current unpushed HEAD content from the active arc: wb git arc propose --amend [-m <replacement-title> [-m <replacement-description>]] -- <claimed-path> [...]",
  "15. Use the same arc continue command after a proposal is committed and before follow-up work.",
  "16. Restore selected paths: wb git arc restore --ref <ref> -- <path> [<path>...]",
  "17. Restore the full arc only after explicit user direction: wb git arc restore --ref <ref> --confirm",
  "",
