...
const LEGACY_CHECKPOINT_MIGRATION_GUIDE = [
  ...
  "4. Active commands resolve this thread's registered arc. Do not pass --ref to add, adopt, remove, compare, diff, or propose.",
  ...
  "14. Propose a normal commit: wb git arc propose [--root <root-id>] -m <fresh-title> [-m <optional-description>] [-- <claimed-path> [<claimed-path>...]]",
  "15. Propose message changes to an exact accepted commit without an active arc: wb git arc propose --amend <proposal-id> -m <replacement-title> [-m <replacement-description>]",
  "16. Amend current unpushed HEAD content from the active arc: wb git arc propose --amend [-m <replacement-title> [-m <replacement-description>]] -- <claimed-path> [...]",
