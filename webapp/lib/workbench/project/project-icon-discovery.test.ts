/*
 * Exports:
 * - No production exports. Tests protect project icon preference, workspace-root ordering, Git-visible admission, and invalid repository markers. Keywords: project, icon, favicon, git, workspace, test.
 */
