/*
 * Exports:
 * - No production exports; Node tests cover structured project catalog caching, coalescing, watcher invalidation, soft TTL refresh, CWD retry, and disposal. Keywords: project, catalog, cache, watcher, cwd, lifecycle, test.
 */
