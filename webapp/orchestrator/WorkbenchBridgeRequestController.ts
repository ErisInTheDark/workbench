...
const BRIDGE_METHOD_RULES: readonly BridgeMethodRule[] = [
  ...
  { harnesses: ["codex"], method: "workbench/subagent/list" },
  { harnesses: ["codex"], method: "workbench/subagent/profiles" },
  { harnesses: ["codex"], method: "workbench/subagent/create" },
  { harnesses: ["codex"], method: "workbench/subagent/wait" },
  { harnesses: ["codex"], method: "workbench/subagent/waitCancel" },
  { harnesses: ["codex"], method: "workbench/subagent/message" },
  { harnesses: ["codex"], method: "workbench/subagent/stop" },
