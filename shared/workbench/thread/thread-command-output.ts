/*
 * Exports:
 * - MAX_THREAD_COMMAND_OUTPUT_CHARS: bound retained command output.
 * - compactCommandOutput: keep recent output with an omission marker.
 * - appendCommandOutputDelta: append output while preserving the omission marker.
 * - compactCommandExecutionItemOutput: bound output without changing other item types.
 * - compactCommandOutputPayload: bound command output inside compatible payloads.
 */
