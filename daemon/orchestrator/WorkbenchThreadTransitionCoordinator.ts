/*
 * Exports:
 * - default WorkbenchThreadTransitionCoordinator: coordinate fair shared reads and exclusive writes by stable keys across reload generations. Keywords: orchestrator, transition, coordinator, thread, reload.
 * - readMany/runMany: acquire several transition keys in stable order for deadlock-free workspace operations. Keywords: transition, multi-root, read, write, lock, ordering.
 */
