/*
 * Exports:
 * - No production exports; Node tests cover server bridge HTTP allowlisting, harness routing, malformed input, and response adaptation. Keywords: bridge, http, allowlist, orchestrator, test.
 */
