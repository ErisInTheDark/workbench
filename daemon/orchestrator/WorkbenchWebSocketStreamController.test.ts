/*
 * Exports:
 * - No production exports; Node tests protect stream health, lag-report rankings and cadence, receipts, reload handoff, and cleanup. Keywords: websocket, stream, backpressure, acknowledgement, test.
 */
