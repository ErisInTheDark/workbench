/*
 * Exports:
 * - GitClaimHistoryDiscovery: typed checkpoint candidates plus unsupported history count. Keywords: Git, claims, history, import.
 * - default GitClaimHistoryReader: decode actual Workbench claim checkpoints and expand declared scopes to workspace files. Keywords: Git, claims, scope, tree.
 */
...
import type { WorkbenchGitClaimImportDiscovery } from "../../../orchestrator/database/stats/WorkbenchStatsImportRepository";
