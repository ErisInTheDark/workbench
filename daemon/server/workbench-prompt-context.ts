/*
 * Exports:
 * - WORKBENCH_PROMPT_CONTEXT_FIELD: private bridge request key carrying Workbench prompt context.
 * - readWorkbenchPromptContext: parse Workbench prompt context from a bridge request.
 */
