/*
 * Exports:
 * - BrowseSessionCleanupSupervisorOptions: injected thread-activity reader and cleanup timing knobs.
 * - default BrowseSessionCleanupSupervisor: long-lived daemon owner for stale Browse session cleanup.
 */
