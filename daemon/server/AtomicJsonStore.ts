 ...
 * - AtomicJsonStoreState/createAtomicJsonStoreState: plain reload-stable queue state shared by fresh store wrappers.
 * - AtomicJsonStore: queue atomic JSON file mutations through temp-file rename writes and bounded journal compaction.
 */
